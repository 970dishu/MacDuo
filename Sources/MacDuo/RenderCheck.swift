...
@MainActor enum RenderCheck {
    ...
    static func run() throws {
        ...
        let report: [String: Any] = ["version":"0.1.13","gpu":device.name,"gradualOnset":gradualOnset,"clearTransitionChecks":clearChecks,"clearDurationSeconds":FoldVisualAnimation.clearDuration,"frameChecks":checkpoints,
